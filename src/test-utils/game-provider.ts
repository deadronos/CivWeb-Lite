...
import type { Dispatch } from '../contexts/game-provider';
...
// Test marker constant - used by tests to verify module loading
export const GAME_PROVIDER_MARKER = true;

/**
 * Creates an initial game state for testing purposes.
 * This is identical to the initialState function from game-provider.tsx
 * but is provided as a test utility to avoid importing production code.
 */
...
/**
 * Simulates advancing a turn given state and dispatch.
 * Exported helper for tests that need to trigger turn advancement.
 */
...
/**
 * Coverage helper to execute some branches for test coverage.
 */
 ...
 * Moved from game-provider.tsx to reduce runtime bundle size.
 */
